...
MIDDLEWARE = [
    ...
    'product.middleware.JWTAuthMiddleware',
    'product.middleware.MediaCorsMiddleware',
]
...
GOOGLE_OAUTH_REDIRECT_URI = os.environ.get('GOOGLE_OAUTH_REDIRECT_URI', 'http://localhost:5174')
